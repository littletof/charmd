...
import {fromMarkdown as mdastFrom} from './mdast-util-from-markdown@0_8_4-shimmed.js';
export type mdastFromMarkdownFn = (markdown: string, encodig?: any, options?: {extensions?: any[], mdastExtensions?: any[]}) => any;
export const fromMarkdown: mdastFromMarkdownFn = mdastFrom as mdastFromMarkdownFn;
